...
//         {/* {result && (
//           <pre className="mt-6 bg-gray-200 p-4 rounded-lg whitespace-pre-wrap text-sm">
//             {JSON.stringify(result, null, 2)}
//           </pre>
//         )} */}

//         {result && (
//   <div className="mt-8 bg-white p-6 shadow rounded-lg space-y-4">

//     <div>
//       <h3 className="font-bold text-lg">Match Score</h3>
//       <p className="text-3xl font-extrabold text-blue-600">{result.match_percentage}%</p>
//     </div>
